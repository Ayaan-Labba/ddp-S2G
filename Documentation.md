...
```
                            ...
                            │  <extra_id_0> e1 <e_type> type <r_type> rel <tail>        │
                            │  <extra_id_1> e2 <nr_type> rel2 <tail> <extra_id_2> e3   │
                            └────────────────────────────┬─────────────────────────────┘
                                                         │
                                                         ▼
                                             ┌───────────────────────┐
...
* **Variant `joint` / `boundary_joint` (Nested)**:
  ...
  - Nests relations: `<r_type> rel_type <tail> <extra_id_{tail_idx}> tail_text` (subsequent relations use `<nr_type>`).
...
* Uses `<tail>` to transition parser state to `EXPECT_TAIL_SENTINEL`.
